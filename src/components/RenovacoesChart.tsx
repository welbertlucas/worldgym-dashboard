...
export function RenovacoesChart({ selectedUnit }: RenovacoesChartProps) {
  ...
  return (
    <div className="rounded-lg border border-border/60 bg-secondary/20 p-4">
      <h3 className="text-[11px] font-bold uppercase tracking-wide text-muted-foreground mb-1">Taxa de Renovação (%)</h3>
      <p className="text-xs font-semibold text-muted-foreground mb-4">Média dos últimos 12 meses: {avgRenovacoes.toFixed(1)}%</p>
